...
export default async function handler(req) {
  ...
  const PROMPT_HOLD_SLUGS = new Set(['newsletter_architecture_agent', 'linkedin_strategy_agent', 'instagram_seed_agent', 'youtube_strategy_agent', 'content_bridge_agent', 'content_repurposing_agent', 'content_scheduler_agent']);
