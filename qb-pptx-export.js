...
(function () {
  ...
  // BrandOS v3.2 has two locked surfaces:
  ...
  function defineMasters(pres, brandLabel) {
    var label = txt(brandLabel) || "BRANDOS";
    pres.defineSlideMaster({
      ...
      objects: [
        ...
        { text: {
            text: TOKENS.mode === "editorial" ? "QUANTUM BRANDING  ·  EDITORIAL" : "BRANDOS  ·  PHASE 01",
  ...
  function addClosingSlide(pres, opts) {
    ...
    s.addText(opts.title || "Built with BrandOS", {
  ...
  function buildProfilesDeck(pres, data, opts) {
    ...
    addClosingSlide(pres, {
      ...
      note: "Generated by BrandOS  ·  app.quantumbranding.ai"
    });
  }
